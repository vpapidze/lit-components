...
__webpack_require__(/*! ./views/app-header */ "./src/views/app-header.ts");
let SimpleGreeting = class SimpleGreeting extends lit_1.LitElement {
    constructor() {
        super(...arguments);
...
SimpleGreeting.styles = lit_1.css `
    :host {
      color: red;
    }
  `;
...
SimpleGreeting = __decorate([
    decorators_js_1.customElement('simple-greeting')
], SimpleGreeting);
...
let AppHeader = class AppHeader extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        // Declare reactive properties
        this.name = 'Header Html';
    }
    // Render the UI as a function of component state
    render() {
        return lit_1.html `<div>${this.name}!</div>`;
    }
};
AppHeader.styles = lit_1.css `
    :host {
      color: green;
    }
  `;
__decorate([
    decorators_js_1.property()
], AppHeader.prototype, "name", void 0);
AppHeader = __decorate([
    decorators_js_1.customElement('app-header')
], AppHeader);
